...
export default function ListaEnderecos(params) {
    ...
    const handleCheck = (itemId) => {
        if (selectedItems[itemId]) {
            // Desmarcar o item atual se já estiver selecionado
            ...
            <View style={styles.descricaoContainer}>
                ...
                <View style={styles.enderecosCart}>
                    <FlatList
                        ...
                        renderItem={({ item }) => {
                            const parametros = {info: informacoes, enderecoId: item.id}
                            return (
                                <TouchableOpacity style={styles.itemCartContainer} onPress={() => { navigation.navigate("Checkout", parametros) }}>
