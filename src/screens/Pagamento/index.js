    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.descricaoContainer}>
                <Text style={styles.enderecoTitulo}>PAGAMENTO</Text>
                ...
                />
                <TextInput style={styles.textInput} placeholder='Nome como está no cartão*' keyboardType="email-address" />
                <MaskedTextInput
                    style={styles.textInput}
            ...
            <View style={styles.rodapeContainer}>
                <TouchableOpacity style={styles.salvarButton}>
                    <Text style={styles.salvarText}>Últimos detalhes</Text>
                </TouchableOpacity>
            </View>
        </View>
    );
