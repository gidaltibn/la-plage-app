...
export default function HomeAuth(params) {
        ...
        return (
            <View style={styles.container}>
                <View style={styles.cabecalho}>
                    <TouchableOpacity style={styles.notificacaoContainer} onPress={
                        () => navigation.navigate("Notifications")
                    }>
                        <Image resizeMode='contain' source={envelope} style={styles.notificacaoIcone} />
                    </TouchableOpacity>

                    <TouchableOpacity style={styles.perfilContainer} onPress={
                        () => navigation.navigate("Info", usuario)
                    }>
                    ...
                    <TouchableOpacity style={styles.favoritosContainer} onPress={
                        () => navigation.navigate("Notifications")
                    }>
                        <Image resizeMode='contain' source={heart} style={styles.favoritoIcone} />
                    </TouchableOpacity>

                    <TouchableOpacity style={styles.carrinhoContainer} onPress={
